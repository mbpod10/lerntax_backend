...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { age: @information.age, dependent: @information.dependent, marital_status: @information.marital_status, name: @information.name, state: @information.state } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { age: @information.age, dependent: @information.dependent, marital_status: @information.marital_status, name: @information.name, state: @information.state } }
